 ...
 * allowing uniform prototypes for function of the pointer struct
 * @arg: a string generated from the getline containing the arguement
 ...
 * @alias: alias node
 * @env_changed: if the environ was changed
 * @status: return status of last command
 * @cmd_buf: the address of pointer to cmd_buf, on chaining
 * @cmd_buf_type: CMD_type ||, &&, ;
 * @readfd: the fd from which to read the line inputs
 ...
 * @type: the builtin command of the flag
